...
use SwipeStripe\Core\Admin\OptionField;
...
class Variation extends DataObject implements PermissionProvider
{
    ...
    public function getCMSFields()
    {
        $fields = new FieldList(
            $rootTab = new TabSet(
                'Root',
                $tabMain = new Tab(Variation::class)
            )
        );
        ...
        $fields->addFieldToTab(
            'Root.Variation',
            PriceField::create(Price::class, Price::class)
    ...
    public function isDuplicate()
    {
        ...
        if ($variationAttributeOptions) {
            $product = $this->Product();
            $variations = DataObject::get(Variation::class, '"Variation"."ProductID" = ' . $product->ID . ' AND "Variation"."ID" != ' . $this->ID);
    ...
    {
        $latestVersion = Versioned::get_latest_version(Variation::class, $this->ID);
    ...
    {
        $latest = DataObject::get_by_id(Variation::class, $this->ID);
