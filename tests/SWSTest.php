...
class SWS_Test extends FunctionalTest
{
    ...
    public function getFormData($formID)
    {
        ...
        if ($page) {
            ...
            if (!$form) {
                user_error("Function getFormData() failed to find the form {$formID}", E_USER_ERROR);
            }
            ...
            user_error('Function getFormData() called when there is no form loaded.  Visit the page with the form first', E_USER_ERROR);
        }
